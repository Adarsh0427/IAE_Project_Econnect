...
const FooterNote = () => (
  <div className="text-xs" data-testid={testIds.LAYOUT.FOOTER}>
    <p>© 2023 by IIIT Sri City Students</p>
    <p>
      <span>Inovation and Entrepreneurship Project</span>
      <span>
        <a
          className="underline"
      ...
      <div className="flex-1">
        <div className="px-6 sm:pr-0">
          ...
          <div className="text-sm tracking-wide sm:mb-5">
            ...
            <p>
              <span>Sri City, Andhra Pradesh 671580</span>
            </p>
            ...
            <p>
              <span>
                <a href="mailto:info@iiits.in" target="_self">
                  info@iiits.in
                </a>
              </span>
            </p>
